...
def filter_by_currency(full_transactions: Any, currency: str) -> Iterator[dict]:
    """функция принимает список словарей и валюту, выдает список отфильтрованых транзакций"""
    for x in full_transactions:
...
usd_transactions = filter_by_currency(full_transactions, "USD")
for _ in range(2):
    print(next(usd_transactions))


def transaction_descriptions(full_transactions: list) -> Any:
